...
class BinarySearchTreeNode<E> {
    ...
    constructor() { _parent = null; _leftChild = null; _rightChild = null
    }
    constructor(entry: E?) { _entry = entry; _parent = null; _leftChild = null; _rightChild = null
    }
    fun getEntry(): E? {
        return _entry
    }
    fun setEntry(newEntry: E) { _entry = newEntry
    }
    ...
    fun setParent(prBSTN: BinarySearchTreeNode<E>?) { _parent = prBSTN
    }
    fun setLeftChild(leftChildBSTN: BinarySearchTreeNode<E>?) { _leftChild = leftChildBSTN
    }
    fun setRightChild(rightChildBSTN: BinarySearchTreeNode<E>?) { _rightChild = rightChildBSTN
    }
